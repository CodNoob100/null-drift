...
def main():
    ...
    ax1.plot(turns_x, standard_context_sizes, color='#ff4b4b', label='Standard (Append-Only)', linewidth=2)
    ax1.plot(turns_x, null_drift_context_sizes, color='#00ff9d', label='null-drift (O(1) State)', linewidth=2)
    ...
    ax2.set_title(f'Total Cumulative Tokens Billed (After {TURNS} Turns)', fontsize=14, pad=15)
